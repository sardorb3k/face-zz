#!/usr/bin/env python3
"""
Rasm faylidan talaba qo'shish (kamera kerak emas)
"""
import sys
import requests
import os
...
def main():
    if len(sys.argv) < 3:
        ...
        print(f"  {sys.argv[0]} T2024001 'Ali Valiyev' image.jpg ali@example.com +998901234567 2 2-A")
        sys.exit(1)
    ...
    print("=" * 60)
    print("🎓 YANGI TALABA QO'SHISH (Fayl orqali)")
    print("=" * 60)
